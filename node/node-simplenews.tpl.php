...
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
         ...
         */?>
        <div id="col_G1" class="col1_layout_320_660">
            ...
            <div id="bloc_grawitz_actus" class="nl-actus">
        ...
        <div id="col_G2" class="col2_layout_320_660">
            ...
            <div class="content">
                  <?php if ($node->field_nl_illustration[0]['view']): ?>
