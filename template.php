...
function cyrano_bl_webform_view_messages($node, $teaser, $page, $submission_count, $limit_exceeded, $allowed_roles) {
...
function cyrano_cg_filefield_file($file) {
...
function cyrano_cg_more_link ($url, $title) {
