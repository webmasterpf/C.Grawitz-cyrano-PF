...
td.colonne-3-nl span{display:block;padding:2px;width:200px;margin:2px;border:2px solid #F29400;}
...
<!-- http://www.lycee-charlotte-grawitz.com/sites/all/themes/Cyrano_CG/images/bg_menu_rp.gif -->
...
<td width="55%" height="100">
      ...
      <img src="http://www.lycee-charlotte-grawitz.com/sites/all/themes/Cyrano_CG/logo.png" alt="Logo LPP C.Grawitz" width="335" height="55"/></a> </div></td>
                <td width="20%" bordercolor="#FF3399">&nbsp;</td>
    </tr>
   
    <tr border="0" style="border-bottom-color: #d6d6d6; border-bottom-width: 1px; border-bottom-style: solid;" class="table-tr-content">
<td style="width:220px;bordercolor:#FF3399; vertical-align:top" class="colonne-1-nl"><!-- liste actus -->
                    <div id="bloc_grawitz_actus" style="background:#CCCCCC;margin:5px;color: #911381;">
    <?php  print $node->field_nl_lastnews[0]['view']  ?></div>      </td>
     ...
     <td height="170" style="width:20%;vertical-align:top;vspace:2px;hspace:2px;" class="colonne-3-nl"><!-- illustration -->
